...
public class ChainedPpmsPasswordProviderFaultTest extends AbstractPpmsOmeroIntegrationTest {
    ...
    public void loginLdapShouldNotAuthIfPpmsUnavailable() {
        String workDescription = "loginLdapShouldNotAuthIfPpmsUnavailable";
   ...
   public void loginPpmsLdapShouldSkipSyncIfPpmsUnavailable() {
     ...
     *  and autonomy levels. */
    @Test(groups = { Groups.INTEGRATION })
    public void loginPpmsLdapShouldFailAuthIfPpmsUnavailable() {
        String workDescription = "loginPpmsLdapShouldNotAuthIfPpmsUnavailable";
        ...
        checkLoginFailure(OmeroUnit.KNOWN_USER, OmeroUnit.KNOWN_PWD, workDescription);
