/*
 *   Integration testing class not distributed with the OME artifacts.
 *
 *   Copied from:
 *   https://github.com/openmicroscopy/openmicroscopy/blob/v.5.0.0/components/common/test/ome/testing/InterceptingServiceFactory.java
 *
 *   See also:
 *   https://github.com/openmicroscopy/openmicroscopy/blob/v.5.0.0/components/server/test/ome/server/itests/AbstractManagedContextTest.java#L147
 *
 *
 *
 *   $Id$
